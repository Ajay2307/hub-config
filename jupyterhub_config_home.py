...
public_hostname = 'a60aa9eb3741f11eaa855061cee4413f-819748500.us-east-2.elb.amazonaws.com:8080'

keycloak_name = os.environ.get('KEYCLOAK_SERVICE_NAME')
#keycloak_hostname = extract_hostname(routes, keycloak_name)
keycloak_hostname = 'a97b7e84273dd11ea92a7022111417e9-97724686.us-east-2.elb.amazonaws.com:8080'
print('keycloak_hostname', keycloak_hostname)

keycloak_realm = os.environ.get('KEYCLOAK_REALM')

keycloak_account_url = 'http://%s/auth/realms/%s/account' % (
...
os.environ['OAUTH2_TOKEN_URL'] = 'http://%s/auth/realms/%s/protocol/openid-connect/token' % (keycloak_hostname, keycloak_realm)
os.environ['OAUTH2_AUTHORIZE_URL'] = 'http://%s/auth/realms/%s/protocol/openid-connect/auth' % (keycloak_hostname, keycloak_realm)
os.environ['OAUTH2_USERDATA_URL'] = 'http://%s/auth/realms/%s/protocol/openid-connect/userinfo' % (keycloak_hostname, keycloak_realm)
...
c.OAuthenticator.oauth_callback_url = 'http://%s/hub/oauth_callback' % public_hostname
